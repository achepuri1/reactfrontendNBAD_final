...
function makeTunnelClient({ settings, logger: defaultLogger, } = {}) {
    ...
    const tunnelServerUrl = (_c = (_b = (_a = settings === null || settings === void 0 ? void 0 : settings.tunnelServerUrl) !== null && _a !== void 0 ? _a : utils.general.getEnvValue('EXECUTION_CLOUD_URL')) !== null && _b !== void 0 ? _b : utils.general.getEnvValue('EG_SERVER_URL')) !== null && _c !== void 0 ? _c : 'https://exec-wus.applitools.com';
    const getTunnelService = utils.general.cachify(async (tunnelServerUrl) => {
        if (settings === null || settings === void 0 ? void 0 : settings.serviceUrl) {
            return { url: settings.serviceUrl, close: () => Promise.resolve() };
        }
        const { port, cleanupFunction } = await (0, execution_grid_tunnel_1.startEgTunnelService)({ egTunnelManagerUrl: tunnelServerUrl, logger });
        return {
    ...
    async function create(credentials) {
        var _a;
        const service = await getTunnelService((_a = credentials.tunnelServerUrl) !== null && _a !== void 0 ? _a : tunnelServerUrl);
    ...
    async function destroy(tunnelId, options) {
        ...
        const service = await getTunnelService((_a = tunnel.credentials.tunnelServerUrl) !== null && _a !== void 0 ? _a : tunnelServerUrl);
        ...
        logger.error(`Failed to delete tunnel with status ${response.status} and code ${(_b = body === null || body === void 0 ? void 0 : body.message) !== null && _b !== void 0 ? _b : 'UNKNOWN_ERROR'}`);
        throw new Error(`Failed to delete tunnel with code ${(_c = body === null || body === void 0 ? void 0 : body.message) !== null && _c !== void 0 ? _c : 'UNKNOWN_ERROR'}`);
    }
