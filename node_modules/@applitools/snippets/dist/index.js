...
var s=function(){"use strict";return function(t){var o=t[0],r=t[1];return o.map((function(t,o){var e=[t];if(t.getRootNode)for(var a=t.getRootNode();a!==document&&a.constructor&&"ShadowRoot"===a.constructor.name;a=a.host.getRootNode())e.push(a.host);var n=r[o];return e.map((function(t){var o=t.getAttribute("data-applitools-selector"),r=o?o+" "+n:n;return t.setAttribute("data-applitools-selector",r),'[data-applitools-selector~="'+n+'"]'}))}))}}();
return s(arg)
}
...
var s=function(){"use strict";return function(o){o[0].forEach((function(o){if(o.removeAttribute("data-applitools-selector"),o.getRootNode)for(var t=o.getRootNode();t!==document&&t.constructor&&"ShadowRoot"===t.constructor.name;t=t.host.getRootNode())t.host.removeAttribute("data-applitools-selector")}))}}();
return s(arg)
}
