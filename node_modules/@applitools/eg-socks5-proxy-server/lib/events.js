...
exports.AUTHENTICATION_ERROR = 'authenticateError';
exports.CONNECTION_FILTER = 'connectionFilter';
exports.HANDSHAKE = 'handshake';
exports.PROXY_END = 'proxyEnd';
exports.ACCEPT_NEW_REQUEST = 'accept-new-request';
exports.CONNECTED_TO_REMOTE_ADDRESS = 'connected-to-remote-address';
exports.CONNECTED_TO_REMOTE_PROXY = 'connected-to-remote-proxy';
exports.REMOTE_PROXY_HANDSHAKE_COMPLETED = 'remote-proxy-handshake-completed';
exports.REMOTE_PROXY_HANDSHAKE_TIMEOUT = 'remote-proxy-handshake-timeout';
exports.REMOTE_PROXY_RFC_1928_REPLY_TIMEOUT = 'remote-proxy-rpc-1928-reply-timeout';
exports.REMOTE_PROXY_RFC_1928_REPLY = 'remote-proxy-rpc-1928-reply';
exports.ORIGIN_SOCKET_ERROR = 'orgin-socket-error';
exports.REMOTE_SOCKET_ERROR = 'remote-socket-error';
